<template>
  ...
  <div class="loginText" >
    <p>Porque cotizar tu nueva etapa en la vida, nunca fue tan fácil.</p>
      ...
      <vs-button class="fbCustom" :color="colorx"  icon-pack="fab" icon="fa-facebook" @click="loginWithFacebook" >Continuar con Facebook</vs-button>
...
#page-login {
background: -moz-linear-gradient(296deg, #53FDC3 0%, #51CEEC 100%); /* ff3.6+ */
background: -webkit-gradient(linear, left top, right bottom, color-stop(0%, #53FDC3), color-stop(100%, #51CEEC)); /* safari4+,chrome */
background: -webkit-linear-gradient(296deg, #53FDC3 0%, #51CEEC 100%); /* safari5.1+,chrome10+ */
background: -o-linear-gradient(296deg, #53FDC3 0%, #51CEEC 100%); /* opera 11.10+ */
